...
public class GetConfigurationResponse {
    ...
    public void setConfigurationKey(List<KeyValue> value) {
        this.configurationKey = null;
        if (value!= null) {
            List<KeyValue> draftl = this.getConfigurationKey();
            draftl.addAll(value);
        }
    }

    public void setUnknownKey(List<String> value) {
        this.unknownKey = null;
        if (value!= null) {
            List<String> draftl = this.getUnknownKey();
            draftl.addAll(value);
        }
    }
